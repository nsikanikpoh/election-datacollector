...
Gem::Specification.new do |s|
  ...
  s.extra_rdoc_files = ["README.md".freeze, "pages/Modes.md".freeze, "pages/Advanced.md".freeze, "pages/Options.md".freeze, "pages/Custom.md".freeze, "pages/Compatibility.md".freeze, "pages/WAB.md".freeze, "pages/Security.md".freeze, "pages/Encoding.md".freeze, "pages/JsonGem.md".freeze, "pages/Rails.md".freeze]
