...
class AffiliationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create affiliation" do
    assert_difference('Affiliation.count') do
      post affiliations_url, params: { affiliation: { affiliate_id: @affiliation.affiliate_id, referred_id: @affiliation.referred_id } }
    end
  ...
  test "should update affiliation" do
    patch affiliation_url(@affiliation), params: { affiliation: { affiliate_id: @affiliation.affiliate_id, referred_id: @affiliation.referred_id } }
